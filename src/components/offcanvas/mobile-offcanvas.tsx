      ...
      <div className={`tp-offcanvas-area ${openOffcanvas ? "opened" : ""}`}>
        <div className="tp-offcanvas-wrapper">
          ...
          <div className="tp-offcanvas-main">
            ...
            {/* Get Started CTA - Fixed at bottom */}
            <div className="tp-offcanvas-cta">
              <div className="tp-offcanvas-cta-btn">
                <Link href="/register" className="tp-btn-get-started-mobile">
                  <span className="tp-btn-text">Bắt Đầu Ngay</span>
                  <span className="tp-btn-arrow">→</span>
                </Link>
                <p className="tp-offcanvas-cta-subtitle">Tham gia cùng chúng tôi hôm nay!</p>
              </div>
            </div>
          </div>
        </div>
